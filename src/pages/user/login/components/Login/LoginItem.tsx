...
export interface LoginItemType {
  ...
  Company: React.FC<WrappedLoginItemProps>;
}
...
const getFormItemOptions = ({ onChange, defaultValue, hidden = false, customProps = {}, rules }: LoginItemProps) => {
  const options: {
    rules?: LoginItemProps['rules'];
    onChange?: LoginItemProps['onChange'];
    initialValue?: LoginItemProps['defaultValue'];
    hidden?: LoginItemProps['hidden'];
  } = {
    hidden,
